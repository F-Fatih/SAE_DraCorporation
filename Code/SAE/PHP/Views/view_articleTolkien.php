...
<link href="Content/css/style_articleTolkien.css" rel="stylesheet">


<!-- Banneer with background image -->
<div class="jumbotron jumbotron-fluid">
  <div class="container-fluid main-image">
    <h1 class="display-4">LES ANNEAUX DU POUVOIR</h1>
    <p class="lead">La série tirée de l'univers culte de Tolkien</p>
  </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="container col-md-8 left">
            ...
            <br>
            <p align="justify" class="indent">La série est produite par Amazon Studios en collaboration avec les éditeurs HaperCollins, Warner Bros, New Line Cinema Studio et Tolkien Estate (la société qui gère les droits de l'auteur).</p>
            <br>

            <h2>Du budget pour les fans</h2>
            <br>
            <p align="justify" class="indent">Avec un budget de 715 millions de dollars (250 millions de dollars et 465 millions de dollars pour les droits de la première saison, selon The Hollywood Reporter), Le Seigneur des anneaux : "Les Anneaux du pouvoirs est la série la plus chère de l'histoire de la télévision. record absolu. À titre de comparaison, huit saisons de Game of Thrones ont coûté 500 millions de dollars à HBO.</p>
            <br>

            <h2>Accessible à tous les néophytes</h2>
            <br>
            <p align="justify" class="indent">Vous n'avez pas besoin de lire Tolkien ou de regarder les deux trilogies de Peter Jackson (Le Seigneur des anneaux et Le Hobbit) pour comprendre Les anneaux de pouvoir. Mais cette série vous donnera certainement envie d'en savoir plus sur la Terre du Milieu, le monde légendaire créé par Tolkien.</p>
            <br>
